...
Future<void> createExcelPurchaseInvoice(
  dataList, {
  ...
  for (var data in dataList) {
    ...
    sheet!
        ...
        .value = TextCellValue("${data['pInvo']}");
    sheet
    ...
    sheet
        ...
        .value = TextCellValue(data['splrInvo']);
    sheet
        .cell(CellIndex.indexByColumnRow(columnIndex: 4, rowIndex: rowIndex))
        .value = TextCellValue(data['spltInvo_Date']);
    sheet
